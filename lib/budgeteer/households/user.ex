defmodule Budgeteer.Households.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :todo_reminders_enabled, :boolean, default: false
    field :auth_providers, {:array, :string}, default: ["email"]
  ...
  """
  def valid_password?(%Budgeteer.Households.User{hashed_password: hashed_password}, password)
